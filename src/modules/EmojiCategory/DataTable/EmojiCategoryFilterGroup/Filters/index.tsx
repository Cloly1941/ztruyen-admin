...
export type TEmojiCategoryFilter = {
    filters: Record<string, string[]>
    onFilterChange: (filters: Record<string, string[]>) => void
}

type TEmojiCategoryFilters = TEmojiCategoryFilter & {
...
const EmojiCategoryFilters = ({filters, onFilterChange, localFilters, setLocalFilters}: TEmojiCategoryFilters) => {
...
export default EmojiCategoryFilters