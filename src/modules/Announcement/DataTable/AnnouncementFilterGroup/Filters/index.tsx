...
export type TAnnouncementFilter = {
    filters: Record<string, string[]>
    onFilterChange: (filters: Record<string, string[]>) => void
}

type TAnnouncementFilters = TAnnouncementFilter & {
...
const AnnouncementFilters = ({filters, onFilterChange, localFilters, setLocalFilters}: TAnnouncementFilters) => {
